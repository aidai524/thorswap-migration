...
/**
 * Preview / confirmation modal before executing THOR → METRO migration.
 * Layout follows Staking / Migration Figma (Confirm Migration).
 */
export function MigrateConfirmDialog({
  ...
  const lockLabel = ThorPhaseConfig[thorPhase].lockDuration;
  const showEarlyTag = thorPhase === "10M";
      ...
      >
        ...
        <div className="bg-white px-6 pb-6 pt-2">
            ...
            <div className="flex min-w-0 flex-1 flex-col items-center gap-4 text-center">
              ...
              <div className="space-y-1">
                <p className="text-2xl font-bold leading-[1.3] text-[#111414]">
                  {thorAmountLabel} {ThorToken.symbol}
                </p>
          ...
          <div className="mt-6 overflow-hidden rounded-lg border border-[rgba(118,121,122,0.2)]">
            <div className="flex items-center justify-between gap-3 border-b border-[rgba(118,121,122,0.2)] px-4 py-3.5">
              ...
              <div className="flex min-w-0 flex-wrap items-center justify-end gap-2.5">
                ...
                {showEarlyTag && (
                  <span className="shrink-0 rounded border border-[rgba(118,121,122,0.2)] bg-[#fff1e8] px-2 py-0.5 text-xs leading-[1.4] text-[#fc7020]">
                    Early Migration
                  </span>
                )}
              </div>
          ...
          >
            <Checkbox
              ...
              className={cn(
                ...
                // Dark fill overrides theme; primary-foreground is dark in .dark, so force a light icon.
          ...
          <p className="mt-4 px-1 text-center text-sm font-normal leading-[1.4] text-black">
            By confirming, you authorise the burn of {thorAmountLabel}{" "}
            {ThorToken.symbol} on {burnChainName}.
            <br />
